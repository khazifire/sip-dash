        ...
        <div className="lg:w-2/6 flex flex-col gap-8">
          ...
          <div>
            <div className="flex flex-row items-center justify-between">
              ...
              <a href="/department/orderRequest" className="text-lg text-primary-color italic font-normal hover:underline hover:decoration-2 underline-offset-2">Learn More</a>
            </div>
            <RecentActivities />
          </div>
          </div>
