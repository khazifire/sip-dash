...
const Navbar = () => {
    ...
    return ( 
        <>
            ...
            {/* <!-- nav --> */}
            <nav>
                <a href="/" className="flex gap-1 items-center py-2.5 px-4 rounded transition duration-200 bg-gray-100/20 hover:text-white">
                ...
                <a href="./admin_users.html" className=" flex gap-1 items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-100/20 hover:text-white">
                ...
                <a href="./admin_department.html" className=" flex gap-1 items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-100/20 hover:text-white">
                ...
                <a href="./admin_location.html" className=" flex gap-1 items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-100/20 hover:text-white">
                ...
                <a href="#" className=" flex gap-1 items-center py-2.5 px-4 absolute bottom-4 w-full left-0 rounded transition duration-200 hover:bg-gray-100/20 hover:text-white">
